...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    edu_o = origin_vl[origin_vl["year"] == y2][
        ["CD_REFNIS", "pct_non_eu27", "pct_etr"]
    ].copy()
    ...
    edu["school_pressure_score"] = (
        minmax(edu["pct_bo_geen_nl"]) * 0.35
        + minmax(edu["pct_so_geen_nl"]) * 0.35
        + minmax(edu["pct_youth_niet_belg"]) * 0.20
    ...
    with col_profile_edu:
        ...
        values = [
            float(minmax(edu["pct_bo_geen_nl"]).loc[profile_idx]),
            float(minmax(edu["pct_so_geen_nl"]).loc[profile_idx]),
            float(minmax(edu["pct_youth_niet_belg"]).loc[profile_idx]),
